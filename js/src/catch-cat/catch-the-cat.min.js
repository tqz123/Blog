!(function (t) {
          ...
          set: function (t) {
            switch (t) {
              case i.PLAYING:
                break;
              case i.LOSE:
                this.setStatusText(f.default("猫猫溜走咯，没逮到哦~"));
                break;
              case i.WIN:
                this.setStatusText(
                  f.default("恭喜你，成功逮到小喵(～￣▽￣)～")
                );
                break;
              default:
                return;
        ...
        (e.prototype.playerClick = function (t, e) {
          ...
          return n
            ? n.isWall
              ...
              ? (this.setStatusText(f.default("别点我！")), !1)
              : ((n.isWall = !0),
                this.cat.isCaught()
                  ? (this.setStatusText(f.default("恭喜你，逮到小猫了~")),
                    (this.state = i.WIN),
                    !1)
                  : (this.setStatusText(
                      f.default("您点击了 ") + "(" + t + ", " + e + ")"
  ...
  function (t, e, n) {
    ...
    var i = n(2),
      s = (function (t) {
        function e(e) {
          var n = t.call(this, e, 0, 0, i.default("俺还要玩儿"), {}) || this;
          n.setColor("#000000");
          var o = e.r;
          n.setFontSize(o),
